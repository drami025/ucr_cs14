...
int main()
{
	...
	cerr << "Last index of Hashy before change: " << (hashy.find(s))->value 
		<< endl;
	cerr << "After change: ";
	
	(hashy.find(s))->value = "squiggly";
	cout << (hashy.find(s))->value << endl;
	
	// cout << "Inserting while hash table is full: ";
	// hashy["what's up!!!"] = "Oh no!";
	
	hashy["second"] = "This is second";
	
	cout << hashy["second"] << endl;
